...
Микросервисы можно поделить по предоставляемым сервисам:
 - Поиск и заказ поездки
 - Получение карты, времени и маршрута поездки
 - Стриминг геопозиции водителя
 - Отзывы
 - Авторизация
...
При обращении к различным микросервисам клиенты исползуют уникальные для микросервисов URL, nginx маршрутизирует 
запросы на требуемые сервисы.
